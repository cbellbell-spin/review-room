...
export class ShareClient {
  ...
  getOriginBaseUrl(): string {
    return this.getOriginBase();
  }
  ...
  async parseShareRequestError(response: Response): Promise<ShareRequestError> {
    return this.parseRequestError(response);
  }
